...
htmlFiles.forEach(filename => {
    ...
    try {
        ...
        // Replace localhost API URL with API Gateway URL
        ...
        // Also handle any hardcoded localhost:3001 references
        content = content.replace(/localhost:3001/g, API_GATEWAY_URL.replace('https://', ''));
